...
//             try {
//                 const response = await axios.get(`process.env.BACKEND_URL/${username}/${id}`);
...
// const response = await axios.put(`process.env.BACKEND_URL/journals/${username}/${id}`, formDataObject);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(
        `process.env.BACKEND_URL/journals/${username}/${id}`,
        formDataObject
      );
