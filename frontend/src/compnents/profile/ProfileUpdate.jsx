...
//             try {
//                 const response = await fetch(`process.env.BACKEND_URL/${username}/getuserdetails`);
...
//             const response = await axios.patch(`process.env.BACKEND_URL/${username}/update-user`, formData, { headers: { 'Content-Type': 'application/json'}});
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.patch(
        `process.env.BACKEND_URL/${username}/update-user`,
        formData,
